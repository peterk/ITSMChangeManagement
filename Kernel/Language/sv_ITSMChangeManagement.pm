...
sub Data {
    ...
    $Self->{Translation}->{'ITSMChange'} = 'Förändring';
    $Self->{Translation}->{'ITSMChanges'} = 'Förändringar';
    $Self->{Translation}->{'ITSM Changes'} = 'Förändringar';
    $Self->{Translation}->{'workorder'} = 'Arbetsorder';
    $Self->{Translation}->{'A change must have a title!'} = 'En förändring måste ha en titel';
    ...
    $Self->{Translation}->{'ActionExecute::successfully'} = 'Gick bra';
    $Self->{Translation}->{'ActionExecute::unsuccessfully'} = 'Gick inte bra';
    $Self->{Translation}->{'Add CAB Template'} = '';
    $Self->{Translation}->{'Add Workorder'} = 'Lägg till arbetsorder';
    $Self->{Translation}->{'Add a workorder to the change'} = 'En arbetsorder som hör till förändringen';
    ...
    $Self->{Translation}->{'Change Overview'} = 'Översikt förändring';
    ...
    $Self->{Translation}->{'Add Change'} = 'Lägg till förändring';
    $Self->{Translation}->{'Select Change Template'} = 'Välj mall för förändring';
    $Self->{Translation}->{'Template'} = 'Mall';
    $Self->{Translation}->{'This field is required.'} = 'Detta fält är obligatoriskt.';
    $Self->{Translation}->{'Time type'} = '';
    $Self->{Translation}->{'Invalid time type.'} = '';
    $Self->{Translation}->{'New time'} = 'Ny tid';
    $Self->{Translation}->{'Create'} = 'Skapa';
    $Self->{Translation}->{'ITSM Change'} = 'Förändring';
    $Self->{Translation}->{'Title'} = 'Titel';
    $Self->{Translation}->{'Description'} = 'Beskrivning';
    $Self->{Translation}->{'Justification'} = 'Motivering';
    $Self->{Translation}->{'Category'} = 'Kategori';
    $Self->{Translation}->{'Input invalid.'} = 'Ogiltig indata.';
    $Self->{Translation}->{'Impact'} = 'Impact';
    $Self->{Translation}->{'Priority'} = 'Prioritet';
    $Self->{Translation}->{'Requested Date'} = 'Begärt datum';
    $Self->{Translation}->{'Invalid date!'} = 'Ogiltigt datum!';
    $Self->{Translation}->{'Attachment'} = 'Bilaga';
    ...
    $Self->{Translation}->{'Changed'} = 'Ändrad';
    $Self->{Translation}->{'Delete Condition'} = 'Radera villkor';
    $Self->{Translation}->{'Add new condition'} = 'Lägg till nytt villkor';

    # Template: AgentITSMChangeConditionEdit
    $Self->{Translation}->{'Edit'} = 'Redigera';
    $Self->{Translation}->{'Condition'} = 'Villkor';
    $Self->{Translation}->{'Need a valid name.'} = 'Ett giltigt namn krävs.';
    $Self->{Translation}->{'A a valid name is needed.'} = 'Ett giltigt namn kävs.';
    ...
    $Self->{Translation}->{'Action'} = 'Åtgärd';
    $Self->{Translation}->{'Details'} = 'Detaljer';
    $Self->{Translation}->{'Workorder'} = 'Arbetsorder';
    $Self->{Translation}->{'User'} = 'Användare';
    $Self->{Translation}->{'Createtime'} = 'Skapad tid';
    ...
    $Self->{Translation}->{'of'} = 'av';
    $Self->{Translation}->{'ChangeManager'} = 'Förändringsmanager';
    $Self->{Translation}->{'User invalid.'} = 'Ogiltig användare.';
    $Self->{Translation}->{'ChangeBuilder'} = 'Förändringsbyggare';
    $Self->{Translation}->{'Change Advisory Board'} = 'Förändringsråd';
